...
Introduced 2026-07-06 evening (Phase 3 initiatives #5 + #6 + #11). Non-negotiable rules for every OTA listing headline / title field. Enforced by Marketing Director + Brand Director on any OTA copy change. See `docs/listings/*/AIRBNB.md#title--locked-ship-string-phase-3-initiative-5-2026-07-06`, `docs/listings/*/VRBO.md#headline--locked-ship-string-phase-3-initiative-6-2026-07-06`, `docs/listings/*/BOOKING.md#property-name--locked-ship-string-phase-3-initiative-11-2026-07-06`, and MASTER §12 for the currently-shipping strings.

...
- Primary booker must be 25 or older; max 8 guests.
...
- Wristbands and parking pass provided at check-in; leave them on the counter when you leave.
- The nearest grocery is Publix, under 1 mile.
- Elevator wait times can be longer at check-in/check-out on Saturdays. Not a dealbreaker — just good to know.
- No smoking, no vaping, no pets, no parties. Quiet hours 10 PM – 8 AM per HOA.
```

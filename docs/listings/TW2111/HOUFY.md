...
| **Sister listing (MS811)** | Pre-rebrand: `Serenity at Majestic Sun` under legacy name *(P1 forbidden-string violation)*. **Rebranded to `Westlight` on 2026-07-09** — see [`../MS811/HOUFY.md`](../MS811/HOUFY.md). | After the MS811 Houfy slug retarget lands, the `Other Listings by Simone` sidebar on the TW2111 Houfy page will display `Westlight` as the sister listing. Live-page verification pending owner Houfy dashboard update. |

...
| Card image | `images/lodging/ms-01-gulf-balcony.jpg` | `coverImage` |
...
**Resort Amenities** — Gulf-Front Outdoor Pool with Sundeck · Indoor Heated Pool · Hot Tubs · Full Fitness Center · Tennis and Pickleball Courts · Championship Golf Course (Seascape Golf Club) · Bicycle and Paddleboard Rentals · Resort Grills

**Location & Access** — Direct Beach Access via Palm-Lined Boardwalk · Elevator Access · Covered On-Site Parking · Walking Distance to Seascape Town Center · Short Walk to Whale's Tale Beach Bar & Grill · ~15 min to VPS Airport
...
- **Parking** — Covered on-site parking is included. ⚠ verify: one assigned space vs. multiple guest-parking passes.
...
`Book Westlight by StayAtFlorida, a Gulf-front 2BR condo in Miramar Beach with panoramic emerald views, resort amenities, and room for 6. Owner-hosted.` *(151 chars — inside the ceiling)*
...
- `panoramic emerald views` — present
- `room for 6` — present
...
- `image` = array of all 57 photo URLs from MASTER §18
...
Use MASTER §18 Photo Caption Library — long-caption column. Every one of the 57 images captioned in MASTER §18.

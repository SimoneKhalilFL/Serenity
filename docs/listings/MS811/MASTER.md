...
- **Booking.com:** Locked 2026-08-26 (evening) on hotel `14120155`. **Non-refundable** (`62977437`) is the PriceLabs parent (min/base/max **$250 / $300 / $750**). **Standard -30D** (`54557813`) is **10% more expensive than Non-refundable**. **Weekly Rate** (`54557815`) is 8% cheaper than Standard. **Monthly rate** (`54563856`) is **20% cheaper than Non-refundable**. Booking.com applies Monthly independently of the PriceLabs floor, so a $300 NR night yields Monthly **$240** (under $250). Do not independently map Standard from PriceLabs — that flattens the 10% premium.
...
**PriceLabs live lock** *(Airbnb parent `42299567`, copied to children, 2026-08-27 evening). Do not flatten. Tidewater floors and occupancy 8 stay off this listing.*

| Lever | Live value |
|---|---|
| Min / base / max | **$250 / $300 / $750** (listing min does not persist below $250; winter $180–$210 is via negative seasonal min, not a lower listing min) |
| Last minute | **No Discount** until ~1 Nov |
| Min stay | Default **2 / 2**. Last-minute **2 / 2**. Far out **2 / 3** beyond 90 days, **3 / 4** beyond 180 days. Orphan 1–2 night gaps use gap length |
| Far Out Premium | **No Far Out Prices** (custom override). Was Market Driven Balanced +20% from 60 days out — that kept Nov–May high |
| Safety Minimum | **No Safety Minimum Price** (custom override). Was 110% of last-year same-day ADR beyond 180 days (~$318 floor on Mar–May) |
| Moon Crush | Seasonal row **Sep 29–Oct 5**, min **+100%** / base **+67%** / max **−25%**. Floor **$500**, cap **$562** so Oct weekends cannot run to listing max / Booking.com ~$938. Calendar after save: 29 Sep **$500**, 22 Oct **$562** |
| Jeepalooza | Seasonal row **Oct 21–25**, same +100% / +67% / −25%. Floor **$500**, cap **$562** |
| Winter (non-holiday) | **Nov 1–Mar 6** (EarlyNov, EarlyDec, Snowbird, LateFeb): min **−28%** / base **−35%** / max **−72%**. Calendar: **$180–$210** (101 nights sampled 27 Aug, avg **$198**). Listing min stays $250; negative seasonal min is what lets winter go under it |
| Spring | SpringBreak **Mar 7–Apr 5** (was Mar 1) base **−10%** / max **−50%**. EasterWeek **+35%** kept. SpringShoulder (Apr 12–May 21) base **−20%** / max **−45%**. Memorial Day **+20%** and EarlySummer (May 27+) unchanged |
| Other holidays | Thanksgiving Nov 20–30 +15/+20/−25 · Christmas Dec 22–30 +15/+20/−15 · NYE Dec 31 +15/+20/−10 · NewYear Jan 1–4 +15/+20/−30 · July 4 left at existing premiums. These stay above the $180–$210 band |
| Off-season min | Sep leftover / LateOctober still **min 0%** so those nights hold the $250 listing floor. Winter rows are the exception (negative min) |

Direct-site $300 base, $250 cleaning, and $50 / 3-night uplift are unchanged — those are this table, not PriceLabs.
...
| 2026-08-26 | §17 Booking.com rate plans locked | Owner-confirmed live setup on hotel `14120155`: PriceLabs writes **Non-refundable** (`62977437`); **Standard -30D** is 10% more expensive than Non-refundable; Weekly 8% off Standard; Monthly 1% off Standard. Min/base/max on the Booking.com PriceLabs child: **$250 / $300 / $750**. Do not independently map Standard from PriceLabs. Cascaded to BOOKING.md + ota-update-tracker item 24. TW2111 not modified. **⚠ SUPERSEDED same evening** — Monthly changed to 20% cheaper than Non-refundable (see next row). | Revenue Manager + Cursor |
| 2026-08-26 | §17 Booking.com Monthly lock updated | Owner changed live Rate Plans: **Monthly** (`54563856`) is now **20% cheaper than Non-refundable** (was 1% cheaper than Standard). Standard +10% vs NR and Weekly −8% vs Standard unchanged. Worked example at $300 NR: Standard $330 · Weekly $303.60 · Monthly $240. Monthly can sit under the PriceLabs $250 min because Booking.com derives it. Cascaded to BOOKING.md + ota-update-tracker item 24. TW2111 not modified. | Revenue Manager + Cursor |
| 2026-08-27 | §21 PriceLabs setup lock | Live on Airbnb `42299567` (copy-to-children on): min/base/max **$250 / $300 / $750** (saved by ignoring PriceLabs’ “min ≤ $240” warning — that warning is why the $250 floor kept reverting). Last-minute **No Discount**. Min stay default **2 / 2**; 1-night only via orphan gaps. Moon Crush (Sep 29–Oct 5) and Jeepalooza (Oct 21–25) seasonal min **+100%** so those nights cannot go below **$500** (owner exception vs the earlier ~$550 cap rec). Off-season seasonal min flattened to **0%** so leftover Sep weekdays hold $250 (8 Sep was $200, now $250). Booking.com rate plans unchanged. TW2111 / Galveston not modified. | Revenue Manager + Cursor |
| 2026-08-27 | §21 winter/spring cut through May | Owner: winter prices still high through May. On Airbnb `42299567` (copy-to-children): Far Out Premium → **No Far Out Prices**; Safety Minimum → **No Safety Minimum Price**; SpringBreak base **−10%**; SpringShoulder base **−20%** / max **−45%**. Easter, Memorial Day, EarlySummer+ peak, Moon Crush / Jeepalooza ≥ **$500**, and $250 listing min unchanged. Sample after refresh: Nov–Feb weekdays **$250**; 15 Mar **$266**; 20 Apr / 10 May **$250**; 24 May **$358**; 5 Jun **$408**; 4 Jul **$525**. Booking.com rate plans unchanged. TW2111 / Galveston not modified. | Revenue Manager + Cursor |
| 2026-08-27 | §21 Moon Crush cap + winter note | Owner: Moon Crush Oct ~$938 too high; winter ~$312 too high. Capped Moon Crush / Jeepalooza max **−25%** (nights **$500–$562**, was $750 on Oct 1–3). Listing min stays **$250** ($200 save does not persist — PriceLabs reverts). Winter weekdays already **$250** in PriceLabs; $312 was the uncapped/unsynced OTA figure. Copy-to-children on. TW2111 / Galveston not modified. | Revenue Manager + Cursor |
| 2026-08-27 | §21 winter $180–$210 Nov 1–Mar 6 | Owner: daily rate **$180–$210** from Nov 1 through Mar 6, excluding holidays. Listing min **$180** does not persist (reverts to $250). Applied via winter seasonal min **−28%** / base **−35%** / max **−72%** on EarlyNov, EarlyDec, Snowbird, LateFeb (LateFeb extended to **Mar 6**; SpringBreak starts **Mar 7**). Holidays kept: Thanksgiving, Christmas, NYE, NewYear Jan 1–4. Moon Crush / Jeepalooza restored to **+100% / +67% / −25%** ($500–$562). Calendar after save: 101 non-holiday nights **$180–$210** (avg $198); 25 Nov **$432**; 24 Dec **$408**; NYE **$459**; 7 Mar **$267**. Copy-to-children + Sync Now. Booking.com rate plans unchanged. TW2111 / Galveston not modified. | Revenue Manager + Cursor |
